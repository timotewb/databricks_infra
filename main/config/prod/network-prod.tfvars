...
resourceGroups = {
  "network" = {
    name = "aue-rg-network-p01" # Resource group name for non-production networking components
  }
}
...
databricks_ncc = {
  prod = {
    name = "aue-dbac-retail-ncc-p01" # NCC for the non-production environment
  }
}
